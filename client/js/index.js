...
// center_right(147-14-13*8,147-14-13*10)
    ...
    Laya.loader.load(["./assets/Assets/Assets/MahjongTiles/Textures/MahjongTile.png"], Laya.Handler.create(null, function(){
        ...
        btn.on(Laya.Event.CLICK, this, side)
        Laya.stage.addChild(btn);
        Laya.stage.on(Laya.Event.RESIZE, null, function (){
            btn.pos(Laya.stage.width / 2 - btn.width * Laya.Browser.pixelRatio / 2, Laya.stage.height - 50 * Laya.Browser.pixelRatio);
        });
    ...
    Laya.loader.load(["./assets/Assets/Assets/MahjongTiles/Textures/MahjongTile.png"], Laya.Handler.create(null, function(){
        ...
        btn.on(Laya.Event.CLICK, this, less1)
        Laya.stage.addChild(btn);
        Laya.stage.on(Laya.Event.RESIZE, null, function (){
            btn.pos(Laya.stage.width / 2 - btn.width * Laya.Browser.pixelRatio / 2, Laya.stage.height - 50 * Laya.Browser.pixelRatio);
        });
...
function add(){
    seat==0?Card.add("left",Mahjong[i],scene):0
    seat==1?Card.add("up",Mahjong[i],scene):0
    seat==2?Card.add("right",Mahjong[i],scene):0
    seat==3?Card.add("down",Mahjong[i],scene):0
    seat++
    if(seat==4){
        seat=0
    }
...
function less(){
    seat1==0?Card.out_card("left","MahjongTiles-Wind_East",scene):0
   seat1==1?Card.out_card("up","MahjongTiles-Wind_East",scene):0
   seat1==2?Card.out_card("right","MahjongTiles-Wind_East",scene):0
   seat1==3?Card.out_card("down","MahjongTiles-Wind_East",scene):0
...
function less1(){
    seat3==0?Card.out_card("left","MahjongTiles-Wind_East",scene,1):0
   seat3==1?Card.out_card("up","MahjongTiles-Wind_East",scene,1):0
   seat3==2?Card.out_card("right","MahjongTiles-Wind_East",scene,1):0
   seat3==3?Card.out_card("down","MahjongTiles-Wind_East",scene,1):0
...
function side(){
    Card.side()
    seat2==0?Card.side("left",["MahjongTiles-Wind_East","MahjongTiles-Bam_2"],["MahjongTiles-Bam_3","MahjongTiles-Bam_4"]):0
    seat2==1?Card.side("up",["MahjongTiles-Wind_East","MahjongTiles-Bam_2"],["MahjongTiles-Bam_3","MahjongTiles-Bam_4"]):0
    seat2==2?Card.side("right",["MahjongTiles-Wind_East","MahjongTiles-Bam_2"],["MahjongTiles-Bam_3","MahjongTiles-Bam_4"]):0
    seat2==3?Card.side("down",["MahjongTiles-Wind_East","MahjongTiles-Bam_2"],["MahjongTiles-Bam_3","MahjongTiles-Bam_4"]):0
