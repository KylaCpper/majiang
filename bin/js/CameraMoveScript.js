...
CameraMoveScript.prototype.updateCamera = function (elapsedTime) {
	if (!isNaN(this.lastMouseX) && !isNaN(this.lastMouseY)) {
		...
		Laya.KeyBoardManager.hasKeyDown(87) && this.camera.moveForward(-this.speed * elapsedTime);
		Laya.KeyBoardManager.hasKeyDown(83) && this.camera.moveForward(this.speed * elapsedTime);
		Laya.KeyBoardManager.hasKeyDown(65) && this.camera.moveRight(-this.speed * elapsedTime);
		Laya.KeyBoardManager.hasKeyDown(68) && this.camera.moveRight(this.speed * elapsedTime);
		Laya.KeyBoardManager.hasKeyDown(32) && this.camera.moveVertical(this.speed * elapsedTime);
		Laya.KeyBoardManager.hasKeyDown(16) && this.camera.moveVertical(-this.speed * elapsedTime);
		if (this.isMouseDown) {
...
module.exports = new CameraMoveScript(); 