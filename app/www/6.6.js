...
/***/ function(module, exports, __webpack_require__) {
	...
	var me = __webpack_require__(22),
	    ani = __webpack_require__(77);
	var cardImg = __webpack_require__(78);
	var parseR = __webpack_require__(79).parseR;
	var WaitableEvent = __webpack_require__(80);
	...
	var Mj = function () {
	    ...
	    _createClass(Mj, [{
	        ...
	        value: function active() {
	            ...
	            Laya.SoundManager.playMusic(__webpack_require__(81));
	            this.mySeat = null;
	            this.activeVideo();
	        }
	    }, {
	        ...
	        key: 'initCardInfo',
	        value: function initCardInfo(cardList) {
	        ...
	        key: 'updateShowCards',
	        value: function updateShowCards(showCards, pos) {
	        ...
	        key: 'anGang',
	        value: function anGang(cardInfo) {
	            var str = '';
	            for (var i = 0; i < 4; i++) {
	        ...
	        key: 'updateThrowCards',
	        value: function updateThrowCards(throwCards, pos) {
	            console.log('this.pos === ' + this.pos);
	            var left = this.pos - 1 < 0 ? 3 : this.pos - 1;
	            var right = this.pos + 1 > 3 ? 0 : this.pos + 1;
	            var dui = this.pos + 2 > 3 ? this.pos - 2 : this.pos + 2;
	        ...
	        key: 'initTime',
	        value: function initTime(time, pos) {
	            var self = this;
	        ...
	        value: function activeVideo() {
	            ...
	            if (!!window.cordova || location.search.indexOf('usepeer') >= 0) {
	                ...
	                (function () {
	                    var callUser = function callUser(id) {
	                        console.log('call', id);
	                    ...
	                    SafePeer = __webpack_require__(82);
	        ...
	        value: function create(opt, cb) {
	            ...
	            async.parallel([function (cb) {
	                Laya.loader.load([{ url: __webpack_require__(67), type: Loader.BUFFER }], Handler.create(null, function () {
	                    cb();
	                }));
	            }, function (cb) {
	                Flash2x.loadScene("f2x", function () {}, function () {
	                    Flash2x.loadScene("win", function () {}, function () {
	                        cb();
	                    });
	                });
	            }], function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cardv = __webpack_require__(79).cardv;
...
/***/ function(module, exports) {
	...
	function calcR(arr) {
		...
		var c = 0,
		    o = null;
		for (var i = 0; i < arr.length; i++) {
			if (arr[i].v >= 10) c++;else o = arr[i].v;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WaitableEvent = function (_EventEmitter) {
		_inherits(WaitableEvent, _EventEmitter);

		function WaitableEvent(waitEvent, opt) {
			_classCallCheck(this, WaitableEvent);

			var _this = _possibleConstructorReturn(this, (WaitableEvent.__proto__ || Object.getPrototypeOf(WaitableEvent)).call(this));

			_this.waitEvent = waitEvent;
			if (!opt) _this.delayAll = true;
			_this._opt = opt;
			_this._e = [];
			_this._delay = true;
			return _this;
		...
		_createClass(WaitableEvent, [{
			key: 'chkDelay',
			value: function chkDelay(op) {
			...
			key: 'emit',
			value: function emit(op) {
				if (op == this.waitEvent) {
					this._delay = false;
					_get(WaitableEvent.prototype.__proto__ || Object.getPrototypeOf(WaitableEvent.prototype), 'emit', this).apply(this, arguments);
					if (this._e instanceof Array) {
						for (var i = 0; i < this._e.length; i++) {
							_get(WaitableEvent.prototype.__proto__ || Object.getPrototypeOf(WaitableEvent.prototype), 'emit', this).apply(this, this._e[i]);
						}
						delete this._e;
					}
					return;
	...
	if (module == __webpack_require__.c[0]) {
		...
		waitE.on('userin', console.log).on('userout', console.log).on('go', console.log);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "bgm2.mp3?1811da5a920109fb631deda9cea942d3";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SafePeer = function (_EventEmitter) {
		_inherits(SafePeer, _EventEmitter);

		function SafePeer(id, opt) {
			_classCallCheck(this, SafePeer);

			var _this = _possibleConstructorReturn(this, (SafePeer.__proto__ || Object.getPrototypeOf(SafePeer)).call(this));
		...
		_createClass(SafePeer, [{
			key: '_start',
			value: function _start() {
				console.log('peer started');
				var self = this;
				this._peer = new Peer(this._id, this._opt).on('open', function () {
			...
			key: 'call',
			value: function call(id, stream, opt, cb) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var require;var require;/*! peerjs build:0.3.13, development. Copyright(c) 2013 Michelle Bu <michelle@michellebu.com> */(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return require(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
